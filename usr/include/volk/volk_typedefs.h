...
typedef void (*p_32f_reciprocal_32f)(float* , const float* , unsigned int );
...
typedef void (*p_32f_s32f_clamppuppet_32f)(float* , const float* , const float , unsigned int );
...
typedef void (*p_32f_s32f_convertpuppet_8u)(uint8_t* , const float* , float , unsigned int );
...
typedef void (*p_32f_x2_powpuppet_32f)(float* , const float* , const float* , unsigned int );
...
typedef void (*p_32fc_index_max_16u)(uint16_t* , const lv_32fc_t* , uint32_t );
typedef void (*p_32fc_index_max_32u)(uint32_t* , const lv_32fc_t* , uint32_t );
...
typedef void (*p_32fc_s32fc_multiply2_32fc)(lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t* , unsigned int );
typedef void (*p_32fc_s32fc_multiply_32fc)(lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t , unsigned int );
typedef void (*p_32fc_s32fc_rotator2puppet_32fc)(lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t* , unsigned int );
typedef void (*p_32fc_s32fc_x2_rotator2_32fc)(lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t* , lv_32fc_t* , unsigned int );
...
typedef void (*p_32fc_x2_s32f_square_dist_scalar_mult_32f)(float* , const lv_32fc_t* , const lv_32fc_t* , float , unsigned int );
typedef void (*p_32fc_x2_s32fc_multiply_conjugate_add2_32fc)(lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t* , const lv_32fc_t* , unsigned int );
...
typedef void (*p_32fc_x2_square_dist_32f)(float* , const lv_32fc_t* , const lv_32fc_t* , unsigned int );
